...
const htmlPages = [
  ...
  createPage('./src/pages/guides/guides_pages/pervaya-pomoshch-pri-rasprostranennyh-situaciyah.html', './pages/guides/guides_pages/pervaya-pomoshch-pri-rasprostranennyh-situaciyah.html', ['main', 'guides', 'dropdown', 'search']),
  createPage('./src/pages/guides/guides_pages/kak-projti-dispanserizaciyu-ot-zapisi-do-rezultatov.html', './pages/guides/guides_pages/kak-projti-dispanserizaciyu-ot-zapisi-do-rezultatov.html', ['main', 'guides', 'dropdown', 'search']),
  createPage('./src/pages/guides/guides_pages/kak-vybrat-vracha-i-ne-oshibitsya.html', './pages/guides/guides_pages/kak-vybrat-vracha-i-ne-oshibitsya.html', ['main', 'guides', 'dropdown', 'search']),
  createPage('./src/pages/guides/guides_pages/kak-ponyat-chto-u-tebya-depressiya.html', './pages/guides/guides_pages/kak-ponyat-chto-u-tebya-depressiya.html', ['main', 'guides', 'dropdown', 'search']),
  createPage('./src/pages/guides/guides_pages/kak-perezhit-bolnichnyj-bez-poteri-deneg-i-nervov.html', './pages/guides/guides_pages/kak-perezhit-bolnichnyj-bez-poteri-deneg-i-nervov.html', ['main', 'guides', 'dropdown', 'search']),
  createPage('./src/pages/guides/guides_pages/kak-podgotovitsya-k-priemu-vracha-chtoby-ne-zabyt-sprosit-vazhnoe.html', './pages/guides/guides_pages/kak-podgotovitsya-k-priemu-vracha-chtoby-ne-zabyt-sprosit-vazhnoe.html', ['main', 'guides', 'dropdown', 'search']),
